...
import { ExtendedError, Namespace, SecurityLevel, ServerReservedEventsMap } from "./namespace";
...
> {
  ...
  public of(
    ...
    securityLevel?: SecurityLevel // Added securityLevel parameter
  ): Namespace<ListenEvents, EmitEvents, ServerSideEvents, SocketData> {
    ...
    if (!nsp) {
      ...
      nsp = new Namespace(this, name, securityLevel); // Pass securityLevel to Namespace
      ...
      nsp.setSecurityLevel(securityLevel); // Set security level if provided
    }
