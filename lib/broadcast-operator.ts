...
// // Wrap with logging
// const loggingBroadcastOperator = new LoggingBroadcastOperator(broadcastOperator);

// // Wrap with compression
// const compressionBroadcastOperator = new CompressionBroadcastOperator(broadcastOperator);

// // Wrap with both logging and compression
// const loggingAndCompressionBroadcastOperator = new CompressionBroadcastOperator(loggingBroadcastOperator);

// // Emit an event with logging and compression
// loggingAndCompressionBroadcastOperator.to("room-101").emit("foo", "bar");
